    ...
    >
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-1">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-xl font-black text-slate-900 tracking-tight">
              Quản Trị Ngân Sách (Budget vs. Actual)
            </h2>
            <p className="text-xs text-slate-500 font-medium">
              Lập ngân sách, kiểm soát tỷ lệ giải ngân và cảnh báo vượt ngân sách theo phòng ban
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2.5">
          <button
            type="button"
            onClick={() => showToast("📝 Đã mở form lập ngân sách kỳ mới!")}
          ...
          <button
            type="button"
            onClick={() => showToast("⚡ Đã gửi cảnh báo vượt ngân sách tới Trưởng bộ phận R&D!")}
          ...
          >
            <IconCheck size={16} />
            <span>Phê duyệt điều chỉnh</span>
          </button>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl p-5 border border-slate-200/90 shadow-2xs space-y-4">
        <div className="flex items-center justify-between pb-2 border-b border-slate-100">
          <h3 className="text-sm font-black text-slate-900">
            Bảng Đối Chiếu Ngân Sách Các Phòng Ban Tháng 08/2026
          </h3>
          <span className="text-xs font-bold text-slate-500">Đơn vị: VNĐ</span>
        </div>
