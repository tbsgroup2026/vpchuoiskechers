    ...
    >
      <div
        className={`max-w-[1400px] mx-auto pointer-events-auto transition-all duration-500 rounded-full px-6 py-3 flex items-center justify-between border ${
          scrolled
            ? 'bg-[#08221a]/95 border-[#2fd39a]/40 shadow-2xl shadow-emerald-950/80 backdrop-blur-2xl py-2.5'
            : 'bg-[#08221a]/80 border-[#2fd39a]/25 backdrop-blur-xl shadow-xl shadow-emerald-950/40'
        }`}
      >
        {/* Brand Logo & Name */}
        ...
        <nav className="hidden xl:flex items-center gap-6 text-xs font-bold text-gray-200 uppercase tracking-widest">
          {/* 1. Trang chủ */}
        ...
        <div className="hidden xl:flex items-center gap-3">
          ...
          {isLoggedIn ? (
            ...
            <Link
              href="/login"
              className="group relative inline-flex items-center gap-2 px-5 py-2 rounded-full bg-gradient-to-r from-[#2fd39a] via-[#f2dc9a] to-[#2fd39a] text-[#08221a] font-extrabold text-xs tracking-wider uppercase shadow-lg shadow-emerald-500/20 hover:brightness-110 active:scale-[0.98] transition-all duration-200"
            >
              <span>Đăng Nhập</span>
