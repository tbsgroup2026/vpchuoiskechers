...
export const SYSTEM_USERS: Record<string, UserProfile> = {
  "202608001": {
    ...
    title: "Trưởng Ban CI & Chuyển Đổi Số",
    department: "CẢI TIẾN LIÊN TỤC (CI)",
    email: "anhy.work.2004@gmail.com",
    phone: "0522511245",
    roleCode: "CI_LEAD",
    roles: ["employee", "department_head", "ci", "ci_lead", "admin"],
    roleLevel: 2,
  ...
  "202608010": {
    ...
    empCode: "202608010",
    name: "Lê Khải",
    title: "Trưởng Ban CI & Sáng Kiến Kaizen",
    department: "CẢI TIẾN LIÊN TỤC (CI)",
    email: "lekhai@tbsgroup.vn",
    phone: "0908123456",
    roleCode: "CI_LEAD",
    roles: ["employee", "department_head", "ci", "ci_lead", "admin"],
    roleLevel: 2,
  ...
  "222102020": {
    userId: 219,
    empCode: "222102020",
    name: "Dư Thị Thanh Tình",
    title: "Trưởng Phòng Quản Trị Nguồn Nhân Lực & Phê Duyệt CI",
    department: "NHÂN SỰ - HC",
    email: "duthithanhtinh@tbsgroup.vn",
    phone: "0909876543",
    roleCode: "CI_LEAD",
    roles: ["employee", "department_head", "ci", "ci_lead", "hr", "admin"],
    roleLevel: 2,
    avatar: "",
    redirectUrl: "/work",
    managedDepartmentId: "ci",
